    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PurchaseResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PurchaseResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
