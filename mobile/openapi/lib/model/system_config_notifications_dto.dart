    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SystemConfigNotificationsDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SystemConfigNotificationsDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
