    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PersonStatisticsResponseDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PersonStatisticsResponseDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
