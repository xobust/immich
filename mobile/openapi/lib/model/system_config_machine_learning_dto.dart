    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SystemConfigMachineLearningDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SystemConfigMachineLearningDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
