    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RatingsUpdate[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RatingsUpdate[$key]" has a null value in JSON.');
        });
        return true;
      }());
